...
public class ClienteDAO<TIPO> extends DAOGenerico<Cliente> implements Serializable {
    ...
    public ClienteDAO() {
        ...
        listaOrdem.add(new Ordem("email", "E-mail", "like")); // elemento 3
        listaOrdem.add(new Ordem("telefone", "Telefone", "like")); // elemento 4
        listaOrdem.add(new Ordem("dataNasc", "Data de Nascimento", "like")); // elemento 5
        listaOrdem.add(new Ordem("dataCad", "Data de Cadastro", "like")); // elemento 6
