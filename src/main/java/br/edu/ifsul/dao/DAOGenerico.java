...
public class DAOGenerico<TIPO> implements Serializable {
    ...
    @PersistenceContext(unitName = "LojaPW_WebPU") // Payara vai instaciar de acordo com o nome da PU em persistence.xml
    ...
    public String getMensagemNavegacao() {
        ...
        if(totalObjetos > 0) {
            ...
            return "Selecione 'Novo' para criar um registro";
        }
    }
